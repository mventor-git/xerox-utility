# HANDOVER
- Completed: bootstrap→run_once + single-box verify + git/GitHub + guide + full setup + polished GUI + hardcode audit.
- Current: ticket-014 completed. Next: downloader browser-flow, then delete UI wiring.
